...
def getBestCpS(buildinglist):
     bestBuilding = building_list[1]
     bestCpS = building_list[1].current_cps
...
print('Images loaded! /n Starting Cookie Bot')
...
building_list = [cursor, grandma]


#assuming a fresh game
cookie_count = 0

nextPurchase = building_list[0]
#Bot Loop
while keyboard.is_pressed('q') == False:      
        ...
        if(cookie_count > nextPurchase.current_cost):   
             ...
             nextPurchase = getBestCpS(building_list)
        ...
        frameMessage = 'Estimation of cookies %s ' %cookie_count
